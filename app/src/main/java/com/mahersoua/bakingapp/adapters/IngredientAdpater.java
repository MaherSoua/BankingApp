...
public class IngredientAdpater extends RecyclerView.Adapter<IngredientAdpater.IngredientViewHolder> {
    ...
    public IngredientViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.ingredient_item_adapter, parent, false);
    ...
    public void onBindViewHolder(@NonNull IngredientViewHolder holder, int position) {
        ...
        String ingredient =  ingredientModel.getIngredient() +" "+ingredientModel.getQuantity() +" "+ingredientModel.getMeasure();
